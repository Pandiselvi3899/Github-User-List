...
const UserInfo = () => {
  ...
  return (
    <div className="py-5">
      <button
        onClick={() => navigate("/")}
        className="px-5 py-1 font-medium mx-1 my-4 bg-green-700 rounded text-gray-200"
      >
        BACK
      </button>
      {user &&
        user?.map((uinfo, i) => (
          ...
          >
            <img
              ...
              className="w-[350px] border-4 border-green-700 md:mx-0 mx-auto"
            />
            <div className="text-lg leading-10 px-3">
              <h1 className="text-3xl pb-4">{uinfo.name}</h1>
              <h1>
                <span className="text-green-700">Login_name</span> :{uinfo.login}
              </h1>
              <h1>
              ...
              <h1>
                <span className="text-green-700">public_repositories : </span>
                {uinfo.public_repos}
              </h1>
              <h1>
              ...
              <a
                ...
                className="text-gray-200 
                  font-semibold rounded cursor-pointer  px-4 py-1 bg-green-700 my-3 tracking-wide"
              >
                Visit
              </a>
            </div>
